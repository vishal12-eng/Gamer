...
const LoginPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden bg-gray-900">
      ...
      <div className="relative z-10 w-full max-w-md p-8 bg-gray-800/40 backdrop-blur-xl border border-white/10 rounded-2xl shadow-2xl animate-fade-in-up">
        <div className="text-center mb-8">
          <LogoIcon className="w-16 h-16 mx-auto mb-4" />
          <h1 className="text-3xl font-extrabold text-white">FutureTechJournal Admin Panel</h1>
          <p className="text-gray-400 text-sm mt-2">Secure Access &middot; FutureTechJournal</p>
        </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <button
                ...
                className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 hover:text-white text-xs uppercase font-bold tracking-wider"
              >
        ...
        <div className="mt-6 text-center text-xs text-gray-500">
          Protected by FTJ-SecureAuth v2.0
        </div>
      </div>
    </div>
  );
